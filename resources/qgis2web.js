...
map.getView().fit([8531215.829687, 1038636.870996, 8541008.217356, 1044121.164872], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA_RESOURCE_INFORMATION_SYSTEM</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (135 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Aranmula Grama Panchayat, situated in the Pathanamthitta district of Kerala, is renowned for its rich cultural and historical heritage.';
            }
